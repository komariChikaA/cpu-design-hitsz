...
#define CHAR_BIT (8)
#define FLOAT_DECIMAL_SCALE 1000.0
            ...
            case 'f':
                {
                    ...
                    integer_part = (int)numfloat;
                    fractional_part =
                        (int)((numfloat - (double)integer_part) * FLOAT_DECIMAL_SCALE);
                    if (fractional_part < 0)
                        fractional_part = -fractional_part;
                    sc_printf("%d.%03d", integer_part, fractional_part);
                }
                break;
